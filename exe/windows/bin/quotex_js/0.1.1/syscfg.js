/*
* Copyright (c) 2021-2024 the CyberX authors
* All rights reserved.
*
...
class SysCfg {
    constructor() {
        ...
        this.local_cpu_thread = 8 // 本机 CPU 逻辑核心使用数量
        this.network_client = { // 网络客户端设置
        ...
        this.plugins = [ // 插件列表
            {"work": true, "name": "quotex_client_future_ctp", "version": "1.0.0"}, // 单独加载插件，不做依赖检查，故依赖项需手动置前
            {"work": true, "name": "quotex_client_stock_ltp", "version": "1.0.0"}, // 单独加载插件，不做依赖检查，故依赖项需手动置前
            {"work": true, "name": "quotex_center", "version": "1.0.0"}
        ]
    }
}
